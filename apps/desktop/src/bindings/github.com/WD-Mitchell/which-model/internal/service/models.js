...
import * as advisory$0 from "../advisory/models.js";
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
import * as company$0 from "../company/models.js";
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore: Unused imports
import * as privacy$0 from "../privacy/models.js";

/**
 * @typedef {Object} AdministrationStatus
 * @property {company$0.Snapshot} policy
 * @property {boolean} native_keychain
 * @property {boolean} use_keychain
 * @property {MaintenanceResult | null} [last_maintenance]
 */
 ...
 * @property {boolean} [command_managed]
 * @property {boolean} [command_available]
 * @property {string} slug
 * @property {string} name
 ...
 * @property {string[] | null} [advisories]
 */
 ...
 * @property {{ [_ in string]?: privacy$0.Report } | null} categories
 ...
 * @property {string} provider
 * @property {string} secure_store - unchanged, unverified, verified
 * @property {string} legacy_copy - retained, removed, recovery
 * @property {string} [recovery_file] - basename only; no identity
 * @property {string} [error]
 */
 ...
 * @property {string} [recommendation_mode]
 ...
 * @property {advisory$0.Report | null} [quota_evidence]
