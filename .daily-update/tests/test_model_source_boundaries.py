...
class SourceBoundaryTests(unittest.TestCase):
    ...
    def test_score_csv_is_tracked(self) -> None:
        score = "data/available_model_scores.csv"
    ...
    def test_default_paths_resolve_to_repository_root(self) -> None:
        self.assertEqual(model_config.DEFAULT_BENCHMARK_CONFIG_PATH, ROOT / "config/benchmarks.toml")
        self.assertEqual(model_config.DEFAULT_PROVIDER_CONFIG_PATH, ROOT / "config/providers.toml")
        self.assertEqual(aa_api.DEFAULT_ENV_PATH, ROOT / ".env")
        self.assertEqual(updater.DEFAULT_OUTPUT_PATH, ROOT / "data/available_model_raw_values.csv")
        self.assertEqual(scores.DEFAULT_INPUT, ROOT / "data/available_model_raw_values.csv")
        self.assertEqual(
            scores.DEFAULT_OUTPUT,
            ROOT / "data/available_model_scores.csv",
        )
