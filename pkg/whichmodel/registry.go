...
// flag structs per registrar) without adding a new registrar. In-process
// hook commands use this to avoid reparenting the active outer tree.
// Feature test files also use this (via
