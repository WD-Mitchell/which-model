...
export function RankCarousel({ items, index, onIndex }) {
    ...
    return (_jsx("div", { className: styles.band, children: _jsxs("div", { className: styles.row, children: [_jsx("button", { type: "button", "aria-label": "previous rank", disabled: prevDisabled, className: cx(styles.chev, prevDisabled && styles.chevDisabled), onClick: () => onIndex(idx - 1), children: _jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M7.2 2.2 3.4 6l3.8 3.8" }) }) }), _jsxs("span", { className: styles.center, children: [_jsx("span", { className: styles.rank, children: rankLine }), _jsx("span", { className: styles.name, children: nameLine }), _jsx("span", { className: styles.meta, children: metaLine }), model && (model.intelligence != null || model.cost != null || model.speed != null) ? (_jsxs("span", { className: styles.ratings, children: [_jsxs("span", { className: styles.ratingItem, children: [_jsx("span", { className: styles.ratingLabel, children: "intel" }), ' ', _jsx("span", { className: styles.ratingValue, children: formatScore(model.intelligence) })] }), _jsx("span", { className: styles.ratingDot, children: "\u00B7" }), _jsxs("span", { className: styles.ratingItem, children: [_jsx("span", { className: styles.ratingLabel, children: "cost" }), ' ', _jsx("span", { className: styles.ratingValue, children: formatScore(model.cost) })] }), _jsx("span", { className: styles.ratingDot, children: "\u00B7" }), _jsxs("span", { className: styles.ratingItem, children: [_jsx("span", { className: styles.ratingLabel, children: "speed" }), ' ', _jsx("span", { className: styles.ratingValue, children: formatScore(model.speed) })] })] })) : null] }), _jsx("button", { type: "button", "aria-label": "next rank", disabled: nextDisabled, className: cx(styles.chev, nextDisabled && styles.chevDisabled), onClick: () => onIndex(idx + 1), children: _jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.7", strokeLinecap: "round", strokeLinejoin: "round", children: _jsx("path", { d: "M4.8 2.2 8.6 6l-3.8 3.8" }) }) })] }) }));
}
